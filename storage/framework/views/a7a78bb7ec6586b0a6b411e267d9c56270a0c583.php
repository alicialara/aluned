...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('apuntes.tablaindex', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
//                $("#myModal").find('.modal-body').html(data);
        ...
        $('button[class*="ver_desglose"]').click(function(e){
            ...
            $.get('/apuntes/ver_desglose?id_tarea='+id_tarea, function(data, status){
//                    $("#myModal").find('.modal-title').html("Añadir horas");
                $("#myModal").find('.modal-body').html(data);
