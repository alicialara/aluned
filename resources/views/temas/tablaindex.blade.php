                ...
                <div class="col-md-12" style="margin-top: 20px;">
                    <table class="table table_modal display compact" id="users-table" cellspacing="0" width="100%">
                        ...
                        @foreach($temas as $tema)
                            ...
                            <tr>
                                <td id="id_{{ $tema->id }}">{{ $tema->id }}</td>
                                <td><span title="{{ $tema->descripcion }}">{{ $tema->titulo }}</span></td>
                                <td>
                                    <?php
                                ...
                                <td>
                                    <select class="form-control id_encuesta" id="{{ $tema->id }}">
                                ...
                                <td><a href="/apuntes?id_tema={{ $tema->id }}" class="btn btn-success btn-block btn-xs" target="_blank">Ver apuntes</a> </td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
